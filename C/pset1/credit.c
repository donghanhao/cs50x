...
int main(void)
{
    ...
    // whether credit card or not
    // get every other digit and multiply by 2
    ...
    //wether the last digit of the sum is zero
    int sum2 = card9 + card10 + card11 + card13 + card14 + card15 + card16;
    int sum3 = sum1 + sum2;
    ...
    // which company if is credit card
    int length = 0;
    long visa = card;
    long amex = card;
    long master = card;
